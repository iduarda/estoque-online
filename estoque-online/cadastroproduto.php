            ...
            <form action="cadastroproduto.php" method="POST">
                ...
                <div class="input-group">
                    <div class="input-box">
                        ...
                        <input id="nomeitem" type="text" name="nomeitem" placeholder="Digite o nome do produto" required>
                    </div>

                    <div class="input-box">
                        <label for="quantitens">Quantidade</label>
                        <input id="quantitens" type="text" name="quantitens" placeholder="Digite a quantidade de itens" required>
                    </div>
                    <div class="input-box">
                        <label for="valcompraitens">Valor de Compra</label>
                        <input id="valcompraitens" type="text" name="valcompraitens" placeholder="Digite o valor de compra " required>
                    </div>

                    <div class="input-box">
                        <label for="valorvendaitens">Valor de venda</label>
                        <input id="valorvendaitens" type="text" name="valorvendaitens" placeholder="Digite o valor de venda " required>
                    </div>
